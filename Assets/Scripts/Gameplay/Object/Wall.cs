...
public class Wall : MonoBehaviour {
    ...
    private void Awake() {
        ...
        Vector2 boardHalfSizeShiftVec = new Vector2(boardHalfLength * (float)Math.Cos(transform.rotation.eulerAngles.z),
                                                    boardHalfLength * (float)Math.Sin(transform.rotation.eulerAngles.z));
